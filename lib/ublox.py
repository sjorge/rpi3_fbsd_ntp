...
Modifications by Jorge Schrauwen
- added UBlox.drain() to flush output buffer
- added MSG_CFG_PMS
'''
import sys
import struct
...
# CFG-MSG messages
MSG_CFG_MSG_NMEA_GGA=0x00
MSG_CFG_MSG_NMEA_GLL=0x01
MSG_CFG_MSG_NMEA_GSA=0x02
MSG_CFG_MSG_NMEA_GSV=0x03
MSG_CFG_MSG_NMEA_RMC=0x04
MSG_CFG_MSG_NMEA_VTG=0x05
MSG_CFG_MSG_NMEA_GRS=0x06
MSG_CFG_MSG_NMEA_GST=0x07
MSG_CFG_MSG_NMEA_ZDA=0x08
MSG_CFG_MSG_NMEA_GBS=0x09
MSG_CFG_MSG_NMEA_DTM=0x0A
MSG_CFG_MSG_NMEA_GNS=0x0D
MSG_CFG_MSG_NMEA_VLW=0x0F
...
POWER_BALANCED = 1
POWER_INTERVAL = 2
POWER_AGGRESSIVE_1HZ = 3
POWER_AGGRESSIVE_2HZ = 4
POWER_AGGRESSIVE_4HZ = 6
POWER_INVALID = 255
...
msg_types = {
    ...
    (CLASS_CFG, MSG_CFG_GNSS): UBloxDescriptor('CFG_GNSS',
                                                  '<BBBBBBBBIBBBBIBBBBIBBBBIBBBBIBBBBIBBBBI',
                                                  ['msgVer', 'numTrkChHw', 'numTrkChUse', 'numConfigBlocks',
                                                   'gnssId0', 'resTrkCh0', 'maxTrkCh0', 'resetved0', 'flags0',
                                                   'gnssId1', 'resTrkCh1', 'maxTrkCh1', 'resetved1', 'flags1',
                                                   'gnssId2', 'resTrkCh2', 'maxTrkCh2', 'resetved2', 'flags2',
                                                   'gnssId3', 'resTrkCh3', 'maxTrkCh3', 'resetved3', 'flags3',
                                                   'gnssId4', 'resTrkCh4', 'maxTrkCh4', 'resetved4', 'flags4',
                                                   'gnssId5', 'resTrkCh5', 'maxTrkCh5', 'resetved5', 'flags5',
                                                   'gnssId6', 'resTrkCh6', 'maxTrkCh6', 'resetved6', 'flags6',
                                                  ]),
    ...
    (CLASS_CFG, MSG_CFG_PMS): UBloxDescriptor('CFG_PMS', '<BBHHH',
